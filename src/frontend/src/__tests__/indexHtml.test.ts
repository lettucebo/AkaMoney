...
// Use the tracked source directly. A comment that resembles a resource declaration
// should fail conservatively rather than introduce an ad-hoc HTML sanitizer.
